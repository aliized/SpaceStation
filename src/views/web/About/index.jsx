    ...
    <div className="container mx-auto flex flex-col-reverse items-center text-lg justify-between lg:flex-row py-8 px-5 gap-10">
      <div className="flex-1 flex justify-center items-center">
        <div className="max-w-xl flex flex-col gap-2">
          <h1 className="text-7xl mb-6 font-anjoman  font-bold ">
            <p className="mb-3 text-5xl">درباره</p> ایستگاه فضایی
          </h1>
          <p>
          ...
          <p>
            سخت تایپ به پایان رسد و زمان مورد نیاز دستاوردهای اصلی، و پیوسته اهل
